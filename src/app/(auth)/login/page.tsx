  ...
  return (
    <div className="flex min-h-dvh flex-col justify-between bg-[#13151b] px-6 py-10 text-white">
      <div className="flex flex-col items-center pt-8">
        <h1 className="text-3xl font-extrabold tracking-tight">GT Duo</h1>
        <p className="mt-2 text-sm text-gray-400">Crescendo juntos, dia após dia.</p>
      </div>
      ...
      <form onSubmit={handleLogin} className="flex flex-col gap-4">
        ...
        <div className="space-y-1">
          <label className="text-xs font-semibold text-gray-400">Usuário</label>

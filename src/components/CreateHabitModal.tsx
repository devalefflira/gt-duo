...
export function CreateHabitModal({ isOpen, onClose, onHabitCreated }: CreateHabitModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/70 p-0 sm:items-center sm:p-4 backdrop-blur-sm">
      <div className="flex max-h-[88dvh] w-full max-w-md flex-col rounded-t-3xl bg-[#1a1e27] text-white shadow-2xl sm:rounded-3xl border border-gray-800">
        
        {/* Header Fixo */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800 shrink-0">
          <h3 className="text-base font-bold">Novo Hábito</h3>
        ...
        <form onSubmit={handleSubmit} className="flex flex-1 flex-col justify-between overflow-y-auto px-6 py-4">
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="mt-1 grid grid-cols-3 gap-2">
                <button
                  ...
                  className={`flex flex-col items-center justify-center gap-1 rounded-xl p-2.5 text-xs font-bold transition-all ${
                    scope === 'individual' ? 'bg-blue-600 text-white shadow-md' : 'bg-[#232834] text-gray-400'
                  }`}
                >
                  <User size={16} />
                ...
                <button
                  ...
                  className={`flex flex-col items-center justify-center gap-1 rounded-xl p-2.5 text-xs font-bold transition-all ${
                    scope === 'duo' ? 'bg-blue-600 text-white shadow-md' : 'bg-[#232834] text-gray-400'
                  }`}
                >
                  <Users size={16} />
                  <span>Duo</span>
                ...
                <button
                  ...
                  className={`flex flex-col items-center justify-center gap-1 rounded-xl p-2.5 text-xs font-bold transition-all ${
                    scope === 'group' ? 'bg-blue-600 text-white shadow-md' : 'bg-[#232834] text-gray-400'
                  }`}
                >
                  <Flame size={16} />
                  <span>Grupo</span>
            ...
            <div>
              ...
              <div className="mt-2 flex items-center justify-between gap-1 rounded-xl bg-[#232834] p-1.5">
                {DAYS_NAMES.map((d) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex h-7 flex-1 items-center justify-center rounded-lg text-[10px] font-bold transition-all ${
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center gap-1 rounded-xl p-2 text-xs font-semibold transition-all ${
            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className="w-full rounded-2xl bg-[#232834] px-4 py-2.5 text-sm text-white placeholder-gray-500 outline-none focus:ring-2 focus:ring-blue-500 pl-10"
                />
                <Clock size={15} className="absolute left-3.5 top-3 text-gray-400" />
              </div>
            </div>
          </div>
          ...
          <div className="pt-4 pb-2">
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-full bg-blue-600 py-3.5 text-center font-bold text-white shadow-lg shadow-blue-600/30 active:scale-[0.98] transition-all disabled:opacity-50"
            >
